export const Abi = [
  {
    inputs: [
      { internalType: 'contract CorkToken', name: '_cork', type: 'address' },
      { internalType: 'address', name: '_devaddr', type: 'address' },
      { internalType: 'uint256', name: '_corkPerBlock', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'cork',
    outputs: [
      { internalType: 'contract CorkToken', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'accCorkPerShare', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
