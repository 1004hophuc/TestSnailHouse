export const Abi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_robiBoost', type: 'uint256' },
    ],
    name: 'addNewLaunch',
    outputs: [],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint32', name: 'sendCount', type: 'uint32' },
  ...
  {
    inputs: [{ internalType: 'uint32', name: '_max', type: 'uint32' }],
    name: 'setMaxToUser',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: '_isUsed', type: 'bool' },
